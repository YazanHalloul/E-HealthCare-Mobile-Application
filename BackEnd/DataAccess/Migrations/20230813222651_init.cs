    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<int>(type: "int", nullable: false),
                    governorate = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reason_of_unavilability = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailableTime", x => x.id);
                    table.ForeignKey(
                        name: "FK_AvailableTime_Day",
                        column: x => x.day_id,
                        principalTable: "Day",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_AvailableTime_Doctor",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    message_content = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableTime_day_id",
                table: "AvailableTime",
                column: "day_id");

            migrationBuilder.CreateIndex(
                name: "IX_AvailableTime_doctor_id",
                table: "AvailableTime",
                column: "doctor_id");

            migrationBuilder.CreateIndex(
                name: "IX_Booking_doctor_id",
                table: "Booking",
                column: "doctor_id");

            migrationBuilder.CreateIndex(
                name: "IX_Booking_patient_id",
                table: "Booking",
                column: "patient_id");
