...
import 'package:doctor/controller/chatMessageController.dart';
            ...
            child: Row(
              children: [
                ...
                CircleAvatar(
                  ...
                  child: Text(
                    Get.arguments.userFirstName[0].toUpperCase(),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "${Get.arguments.userFirstName} ${Get.arguments.userLastName}",
                      ...
                      return LayoutBuilder(builder:
                        ...
                        return SizedBox(
                            ...
                            child: ListTile(
                              ...
                              title: Align(
                                alignment:
                                    controller.message2[index].byPatient == true
                                        ? Alignment.topLeft
                                        : Alignment.topRight,
                      ...
                      onPressed: () async {
                        if (controller.textEditingController.text.isNotEmpty) {
                          ...
                          if (controller.editing) {
                            DoctorApi().updateMessage(
                                controller.message2[controller.messageIndex].id,
                                textFieldContent);
